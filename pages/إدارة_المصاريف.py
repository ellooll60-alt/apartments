...
# ============================
def ensure_expenses_columns():
    queries = [
        "ALTER TABLE expenses ADD COLUMN IF NOT EXISTS unit_no text;",
        "ALTER TABLE expenses ADD COLUMN IF NOT EXISTS booking_id integer;"
    ]
    for q in queries:
        try:
...
ensure_expenses_columns()

# ============================
# 📌 تحميل الوحدات والحجوزات
# ============================
